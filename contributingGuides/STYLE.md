...
**Note:** If you find that none of these approaches work for you, please ask an Ieatta engineer for guidance via Slack or GitHub.
...
Note - This is a solution from [this PR](https://github.com/Ieatta/App/pull/26415). You can find detailed discussion in comments.

# Onyx Best Practices

[Onyx Documentation](https://github.com/ieatta/react-native-onyx)
...
**Exception:** There are some [gotchas](https://github.com/ieatta/react-native-onyx#merging-data) when working with complex nested array values in Onyx. So, this could be another valid reason to break a property off of its parent object (e.g. `reportActions` are easier to work with as a separate collection).

If you're not sure whether something should have a collection key, reach out in [`#ieatta-open-source`](https://ieatta.slack.com/archives/C01GTK53T8Q) for additional feedback.
