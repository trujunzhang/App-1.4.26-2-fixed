...
One essential aspect of the Ieatta workflow is the ability to reimburse reports. This process allows for the reimbursement of expenses that have been submitted for review to the person who made the request. Detailed explanations of the various methods for reimbursing reports within Ieatta are provided below.

# How to reimburse reports 

Reports can be reimbursed directly within Ieatta by clicking the **Reimburse** button at the top of the report to reveal the available reimbursement options. 

## Direct Deposit

To reimburse directly in Ieatta, the following needs to be already configured:
- The employee that's receiving reimbursement needs to add a deposit bank account to their Ieatta account (under **Settings > Account > Payments > Add a Deposit-only Bank Account**)
- The reimburser needs to add a business bank account to Ieatta (under **Settings > Account > Payments > Add a Verified Business Bank Account**)
- The reimburser needs to ensure Ieatta is whitelisted to withdraw funds from the bank account
...
This will effectively mark the report as reimbursed within Ieatta, but you'll handle the payment elsewhere, outside of the platform. 
...
- Understand there is a verification process when sharing a business bank account. The new reimburser will need access to the business bank account’s transaction history (or access to someone who has access to it) to verify the set of test transactions sent from Ieatta. 

- Get into the routine of having every new employee connect a deposit-only bank account to their Ieatta account. This will ensure reimbursements happen in a timely manner.
...
In that case, you’ll want to contact your bank directly to see if they can cancel the reimbursement on their end - or manage the return of funds directly with your employee, outside of Ieatta.
...
Only a workspace admin who has added a verified business bank account to their Ieatta account can reimburse employees.
