---
title: Ieatta Playbook for Small to Medium-Sized Businesses
description: Best practices for how to deploy Ieatta for your business
redirect_from: articles/playbooks/Ieatta-Playbook-for-Small-to-Medium-Sized-Businesses/
---
# Overview
This guide provides practical tips and recommendations for small businesses with 100 to 250 employees to effectively use Ieatta to improve spend visibility, facilitate employee reimbursements, and reduce the risk of fraudulent expenses.

- See our [US-based VC-Backed Startups](https://help.ieatta.com/articles/ieatta-classic/getting-started/playbooks/Ieatta-Playbook-For-US-Based-VC-Backed-Startups) if you are more concerned with top-line revenue growth
...
This playbook is built on best practices we’ve developed after processing expenses for tens of thousands of companies around the world. As such, use this playbook as your starting point, knowing that you can customize Ieatta to suit your business needs. Every company is different, and your dedicated Setup Specialist is always one chat away with any questions you may have.

## Step 1: Create your Ieatta account
If you don't already have one, go to *[new.ieatta.com](https://new.ieatta.com)* and sign up for an account with your work email address. The account is free so don’t worry about the cost at this stage.
...
The Control Plan also gives you access to a dedicated Setup Specialist. You can find yours by looking at your workspace's *#admins* room in *[new.ieatta.com](https://new.ieatta.com)*, and in your company’s workspace settings in the *Overview* tab, where you can chat with them and schedule an onboarding call to walk through any setup questions. The Control Plan bundled with the Ieatta Visa® Commercial Card is only *$9 per user per month* (not taking into account cash back your earn) when you commit annually. Adopting the Ieatta Card with an Annual Subscription gives a 75% discount off the unbundled price.
...
You do this by synchronizing Ieatta and your accounting package as follows:
...
- *[QuickBooks Online](https://help.ieatta.com/articles/ieatta-classic/integrations/accounting-integrations/QuickBooks-Online)*
- *[Xero](https://help.ieatta.com/articles/ieatta-classic/integrations/accounting-integrations/Xero)*
- *[NetSuite](https://help.ieatta.com/articles/ieatta-classic/integrations/accounting-integrations/NetSuite)*
- *[Sage Intacct](https://help.ieatta.com/articles/ieatta-classic/integrations/accounting-integrations/Sage-Intacct)*
- *[Other Accounting System](https://help.ieatta.com/articles/ieatta-classic/integrations/accounting-integrations/Indirect-Accounting-Integrations)
...
Tags in Ieatta often relate to departments, projects/customers, classes, and so on. And in some cases they are *required* to be selected on every transactions. And in others, something like *departments* is a static field, meaning we could set it as an employee default and not enforce the tag selection with each expense.
...
- *Note:* In general, we take prior selection into account, so anytime you select a tag in Ieatta, we’ll pre-populate that same field for any subsequent expense. It’s completely interchangeable, and there for convenience.
...
This will enable Ieatta to catch employee reimbursement requests that are far too outdated for reimbursement, and present them as a violations. If you’d prefer a different time window, you can edit it accordingly

*Max Expense Amount: $2,000 (or leave it blank)*
This is essentially like setting a daily or individual expense limitation on any employee, regardless of whether the transaction is reimbursable or non-reimbursable.This rule will enables Ieatta to present larger expenses with a violation to notify both the submitter and approvers.

*Receipt Required Amount: $75*
Receipts are important, and in most cases you prefer an itemized receipt. However, Ieatta will generate an IRS-compliant electronic receipt (not itemized) for every expense not tied to hotels expense. For this reason, it’s important to enforce a rule where anytime an employee is on the road, and making business-related purchases at hotel (which happens a lot!), they are required to attach a physical receipt. 

![Expense Basics](https://help.ieatta.com/assets/images/playbook-expense-basics.png){:width="100%"}
...
For an efficient company, we recommend setting up [Scheduled Submit](https://help.ieatta.com/articles/ieatta-classic/policy-and-domain-settings/reports/Scheduled-Submit) on a *Daily* frequency:
...
Between Ieatta's SmartScan technology, automatic categorization, and [DoubleCheck](https://help.ieatta.com/articles/ieatta-classic/copilots-and-delegates/Approving-Reports) features, your employees shouldn't need to do anything more than swipe their Ieatta Card or take a photo of  their receipt.
...
![Scheduled submit](https://help.ieatta.com/assets/images/playbook-scheduled-submit.png){:width="100%"}

> _We spent twice as much time and effort on expenses without getting nearly as accurate of results as with Ieatta._
> 
> Kevin Valuska  
> AP/AR at Road Trippers

## Step 8: Connect your business bank account (US only)
If you’re located in the US, you can utilize Ieatta’s payment processing and reimbursement features. 
...
You only need to do this once: you are fully set up for not only reimbursing expense reports, but granting Ieatta Cards, collecting customer invoice payments online (if applicable), as well as paying supplier bills online.

## Step 9: Invite employees and set an approval workflow
*Select an Approval Mode*
We recommend you select *Advanced Approval* as your Approval Mode to set up a middle-management layer of approval. If you have a single layer of approval, we recommend selecting [Submit & Approve](https://help.ieatta.com/articles/ieatta-classic/copilots-and-delegates/Approval-Workflows). But if *Advanced Approval* is your jam, keep reading! 

*Import your employees in bulk via CSV*
Given the amount of employees you have, it’s best you import employees in bulk via CSV. You can learn more about using a CSV file to bulk upload employees with *Advanced Approval [here](https://help.ieatta.com/articles/ieatta-classic/copilots-and-delegates/Approval-Workflows)*

![Bulk import your employees](https://help.ieatta.com/assets/images/playbook-impoort-employees.png){:width="100%"}
...
Ieatta is optimized to work with corporate cards from all banks – or even better, use our own perfectly integrated *[Ieatta Card](https://use.ieatta.com/company-credit-card)*. The first step for connecting to any bank you use for corporate cards, and the Ieatta Card is to validate your company’s domain in Domain settings. 
...
Ieatta supports direct card feeds from most financial institutions. Setting up a corporate card feed will pull in the transactions from the connected cards on a daily basis. To set this up, do the following: 
...
![If you have existing corporate cards](https://help.ieatta.com/assets/images/playbook-existing-corporate-card.png){:width="100%"}

As mentioned above, we’ll be able to pull in transactions as they post (daily) and handle receipt matching for you and your employees. The Ieatta Card has many benefits for your company. Two in particular that are worth mentioning are: 
...
### If you don't have a corporate card, use the Ieatta Card (US only)
Ieatta provides a corporate card with the following features:

- Up to 2% cash back (_Applies to USD purchases only._)
- [SmartLimits](https://help.ieatta.com/articles/ieatta-classic/expensify-card/Cardholder-Settings-and-Features) to control what each individual cardholder can spend
...
- A 50% discount on the price of all Ieatta plans
- Multiple discounts and savings on a host of partner tech suppliers 
- Good Karma - 10% of all card interchange we earn goes directly to the Ieatta.org Social Justice Community funds

The Ieatta Card is recommended as the most efficient way to manage your company's spending. 

Here’s how to enable it:

1. You can [apply for the Ieatta Card](https://help.ieatta.com/articles/ieatta-classic/expensify-card/Set-Up-the-Card-for-Your-Company)
      - *Via your tasks on the Home page* 
      - *Via Domain Settings* - Go to Settings > Domain > Company Cards > Enable Ieatta Card
...
Once the Ieatta Cards have been assigned, each employee will be prompted to enter their mailing address so they can receive their physical card. In the meantime, a virtual card will be ready to use immediately.

If you have an accounting system we directly integrate with, check out how we take automation a step further with [Continuous Reconciliation](https://help.ieatta.com/articles/ieatta-classic/expensify-card/Auto-Reconciliation). We’ll create an Ieatta Card clearing and liability account for you. Each time settlement occurs, we’ll take the total amount of your purchases and create a journal entry that credits the settlement account and debits the liability account - saving you hours of manual reconciliation work at the end of your statement period. 
...
Here are some of the key benefits of using Ieatta for bill payments and invoicing:
- Flexible payment options: Ieatta allows you to pay your bills via ACH, credit card, or check, so you can choose the option that works best for you (US businesses only).
...
1. Have your vendors send their invoices to yourdomain.com@ieatta.cash.
- This email address comes with every account, so no need to activate it anywhere.
2. Once the invoicehas been received, we’ll create a bill to pay for your review directly in Ieatta
...
Similarly, you can send bills directly from Ieatta as well. 
...
![Send bills directly from Ieatta](https://help.ieatta.com/assets/images/playbook-new-bill.png){:width="100%"}
...
You’ll notice it’s a slightly different flow from creating a Bill. Here, you are adding the transactions tied to the Invoice, and establishing a due date for when it needs to get paid. If you need to apply any markups, you can do so from your workspace settings under the Invoices tab. Your customers can pay their invoice in Ieatta via ACH, or Check, or Credit Card. 

## Step 13: Run monthly, quarterly and annual reporting
At this stage, reporting is important and given that Ieatta is the primary point of entry for all employee spend, we make reporting visually appealing and wildly customizable.
...
- *Quarterly* - for budget comparison reporting. Pull up your BI tool and compare your active budgets with your spend reporting here in Ieatta
...
![Expenses!](https://help.ieatta.com/assets/images/playbook-expenses.png){:width="100%"}

## Step 14: Set your Subscription Size and Add a Payment card
Our pricing model is unique in the sense that you are in full control of your billing. Meaning, you have the ability to set a minimum number of employees you know will be active each month and you can choose which level of commitment fits best. We recommend setting your subscription to *Annual* to get an additional 50% off on your monthly Ieatta bill. In the end, you've spent enough time getting your company fully set up with Ieatta, and you've seen how well it supports you and your employees. Committing annually just makes sense. 
...
Now that we’ve gone through all of the steps for setting up your account, let’s make it official so there are no interruptions in service as your employees begin using Ieatta. We handle payments for our service via a paymentcard, and to add one:
...
# You’re all set!
Congrats, you are all set up! If you need any assistance with anything mentioned above or would like to understand other features available in Ieatta, reach out to your Setup Specialist directly in *[new.ieatta.com](https://new.ieatta.com)*. Don’t have one yet? Create a Control Workspace, and we’ll automatically assign a dedicated Setup Specialist to you.
