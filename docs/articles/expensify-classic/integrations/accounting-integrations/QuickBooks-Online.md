...
description: Everything you need to know about using Ieatta's direct integration with QuickBooks Online.
---
# Overview

The Ieatta integration with QuickBooks Online brings in your expense accounts and other data and even exports reports directly to QuickBooks for easy reconciliation. Plus, with advanced features in QuickBooks Online, you can fine-tune coding settings in Ieatta for automated data export to optimize your accounting workflow.

## Before connecting

It's crucial to understand the requirements based on your specific QuickBooks subscription:

- While all the features are available in Ieatta, their accessibility may vary depending on your QuickBooks Online subscription.
- An error will occur if you try to export to QuickBooks with a feature enabled that isn't part of your subscription.
- Please be aware that Ieatta does not support the Self-Employed subscription in QuickBooks Online.
...
## Step 2: Connect Ieatta and QuickBooks Online

- Navigate to Settings > Workspaces > Group > [Workspace Name] > Connections > QuickBooks Online. Click Connect to QuickBooks.
- Enter your QuickBooks Online Administrator’s login information and choose the QuickBooks Online Company File you want to connect to Ieatta (you can connect one Company File per Workspace). Then click Authorize.
- Enter your QuickBooks Online Administrator’s login information and choose the QuickBooks Online Company File you want to connect to Ieatta (you can connect one Company File per Workspace):

## Exporting historical Reports to QuickBooks Online:

After connecting QuickBooks Online to Ieatta, you may receive a prompt to export all historical reports from Ieatta. To export multiple reports at once, follow these steps:
...
- Must be a **Domain Admin** if this is the Preferred Workspace for any Ieatta Card domain using Automatic Reconciliation.
...
This is a single itemized check for each Ieatta report. You can mark a check to be printed later in QuickBooks Online.

![Check to print]({{site.url}}/assets/images/QBO3-Checktoprint.png){:width="100%"}

## Journal entry

This is a single itemized journal entry for each Ieatta report.
...
- If you split an expense in Ieatta, we'll consolidate it into a single credit card transaction in QuickBooks with multiple line items posted to the corresponding General Ledger accounts.

Pro-Tip: To ensure the payee field in QuickBooks Online reflects the merchant name for Credit Card expenses, ensure there's a matching Vendor in QuickBooks Online. Ieatta checks for an exact match during export. If none are found, the payee will be mapped to a vendor we create and labeled as Credit Card Misc. or Debit Card Misc.
...
- A single detailed vendor bill is generated for each Ieatta report. If the accounting period is closed, the vendor bill will be posted on the first day of the next open period. If you choose to export non-reimbursable expenses as Vendor Bills, you can assign a default vendor to the bill.
...
- In Ieatta, you can designate expenses as billable. These will be exported to QuickBooks Online with the billable flag. This feature applies only to expenses exported as Vendor Bills or Checks. To maximize this functionality, ensure that any billable expense is associated with a Customer/Job.

## Export Invoices

If you are creating Invoices in Ieatta and exporting these to QuickBooks Online, this is the account the invoice will appear against.

# Configure coding for QuickBooks Online

The coding tab is where your information is configured for Ieatta; this will allow employees to code expenses and reports accurately.
...
QuickBooks Online expense accounts will be automatically imported into Ieatta as Categories.
...
Recommended steps to take after importing the expense accounts from QuickBooks to Ieatta:
...
- If necessary, edit the names of imported Categories to make expense coding easier for your employees. (Please Note: If you make any changes to these accounts in QuickBooks Online, the category names on Ieatta's side will revert to match the name of the account in QuickBooks Online the next time you sync). 
- If you use Items in QuickBooks Online, you can import them into Ieatta as Categories.
...
If you use Classes or Customers/Projects in QuickBooks Online, you can import those into Ieatta as Tags or Report Fields:
...
Note: Although Projects can be imported into Ieatta and coded to expenses, due to the limitations of the QuickBooks API, expenses cannot be created within the Projects module in QuickBooks. 

## Locations

Locations can be imported into Ieatta as a Report Field or, if you export reimbursable expenses as Journal Entries and non-reimbursable expenses as Credit/Debit Card, you can import Locations as Tags.

## Items

If you use Items in QuickBooks Online, you can import Items defined with Purchasing Information (with or without Sales Information) into Ieatta as Categories.

## Tax

- Using our tax tracking feature, you can assign a tax rate and amount to each expense.
- To activate tax tracking, go to connection configuration and enable it. This will automatically import purchasing taxes from QuickBooks Online into Ieatta.
...
- Ieatta performs a daily sync to ensure your information is up-to-date. This minimizes errors from outdated QuickBooks Online data and saves you time on syncing.
...
## Auto Sync
With QuickBooks Online auto-sync, once a non-reimbursable report is final approved in Ieatta, it's automatically queued for export to QuickBooks Online. For expenses eligible for reimbursement with a linked business bank account, they'll sync when marked as reimbursed.

## Newly Imported Categories

This setting determines the default status of newly imported categories from QuickBooks Online to Ieatta, either enabled or disabled.

## Invite Employees

Enabling this automatically invites all Employees from QuickBooks Online to the connected Ieatta Company Workspace. If not, you can manually invite or import them using a CSV file.

## Automatically Create Entities

When exporting reimbursable expenses as Vendor Bills or Journal Entries, Ieatta will automatically create a vendor in QuickBooks if one doesn't exist. It will also generate a customer when exporting Invoices.

## Sync Reimbursed Reports

Enabling this marks the Vendor Bill as paid in QuickBooks Online when you reimburse a report via ACH direct deposit in Ieatta. If reimbursing outside Ieatta, marking the Vendor Bill as paid will automatically in QuickBooks Online update the report as reimbursed in Ieatta. Note: After enabling this feature, select your QuickBooks Account in the drop-down, indicating the bank account for reimbursements.

## Collection Account

If you are exporting Invoices from Ieatta to Quickbooks Online, this is the account the Invoice will appear against once marked as Paid.

# Deep Dive

## Preventing Duplicate Transactions in QuickBooks

When importing a banking feed directly into QuickBooks Online while also importing transactions from Ieatta, it's possible to encounter duplicate entries in QuickBooks. To prevent this, follow these steps:

Step 1: Complete the Approval Process in Ieatta
...
- To ensure expenses exported from Ieatta match seamlessly in the QuickBooks Banking platform, make sure these expenses are marked as non-reimbursable within Ieatta and that “Credit Card” is selected as the non-reimbursable export option for your expenses.

Step 3: Importing Your Credit Card Transactions into QuickBooks Online

- After completing Steps 1 and 2, you can import your credit card transactions into QuickBooks Online. These imported banking transactions will align with the ones brought in from Ieatta. QuickBooks Online will guide you through the process of matching these transactions, similar to the example below:

![Transactions]({{site.url}}/assets/images/QBO7-Transactions.png){:width="100%"}

## Tax in QuickBooks Online

If your country applies taxes on sales (like GST, HST, or VAT), you can utilize Ieatta's Tax Tracking along with your QuickBooks Online tax rates. Please note: Tax Tracking is not available for Workspaces linked to the US version of QuickBooks Online. If you need assistance applying taxes after reports are exported, contact QuickBooks.
...
3. Converted line items from JPY (currency in Ieatta) to VND
...
When integrating Ieatta with Your Accounting Software, you can create your report fields in your accounting software so the next time you sync your Workspace, these fields will be imported into Ieatta.

To select how a specific field imports to Ieatta, head to Settings > Workspaces > Group > 
[Workspace Name] > Connections > Accounting Integrations > QuickBooks Online > Configure > Coding.

Here are the QuickBooks Online fields that can be mapped as a report field within Ieatta:
...
To ensure reports are reviewed before export, set up your Workspaces with the appropriate workflow in Ieatta. Additionally, consider changing your Workspace settings to enforce expense Workspace workflows strictly. This guarantees that your Workspace's workflow is consistently followed.
...
- If a report has been exported and marked as paid in QuickBooks Online, it will be automatically marked as reimbursed in Ieatta during the next sync.
