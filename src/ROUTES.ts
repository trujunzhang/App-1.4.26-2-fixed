...
const ROUTES = {
    ...
    EDIT_EVENT: {
        route: 'edit/e/:eventId/:restaurantId',
        getRoute: ({eventId, restaurantId}: {eventId: string; restaurantId: string}) => `edit/e/${eventId}/${restaurantId}` as const,
    },
    EDIT_RECIPE: {
        route: 'edit/m/:recipeId/:restaurantId',
        getRoute: ({recipeId, restaurantId}: {recipeId: string; restaurantId: string}) => `edit/m/${recipeId}/${restaurantId}` as const,
    },
    EDIT_REVIEW: {
    ...
    PHOTOS_GRID_VIEW: {
        route: 'photos/grid/:relatedId/:photoType',
        getRoute: ({relatedId, photoType}: {relatedId: string; photoType: PhotoType | string}) => `photos/grid/${relatedId}/${photoType}` as const,
    },
    PHOTOS_PAGE_VIEW: {
        route: 'photos/page/:relatedId/:photoType/:selected',
        getRoute: ({relatedId, photoType, selected}: {relatedId: string; photoType: PhotoType | string; selected: string}) => `photos/page/${relatedId}/${photoType}/${selected}` as const,
    },
    TAKE_PHOTO: {
        route: 'photos/take/:relatedId/:photoType/:pageId',
        getRoute: ({relatedId, photoType}: {relatedId: string; photoType: PhotoType | string}) => `photos/take/${relatedId}/${photoType}/${documentIdFromCurrentDate()}` as const,
    },
    LOCAL_PHOTOS: {
