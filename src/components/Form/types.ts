...
import type NetSuiteMenuWithTopDescriptionForm from '@expPages/workspace/accounting/netsuite/import/NetSuiteImportCustomFieldNew/NetSuiteMenuWithTopDescriptionForm';
