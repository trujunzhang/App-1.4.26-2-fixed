...
type AddRestaurantActionButtonProps = {
    /* Callback to fire on request to toggle the AddRestaurantActionButton */
...
function AddRestaurantActionButton({onPress, isActive, accessibilityLabel, role}: AddRestaurantActionButtonProps, ref: ForwardedRef<HTMLDivElement | View | Text>) {
...
AddRestaurantActionButton.displayName = 'AddRestaurantActionButton';

export default forwardRef(AddRestaurantActionButton);
