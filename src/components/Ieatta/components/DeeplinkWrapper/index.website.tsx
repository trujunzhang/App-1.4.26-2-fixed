...
import {beginDeepLinkRedirectAfterTransition} from '@userActions/App';
import {beginMyDeepLinkRedirect} from '@userActions/ieatta/betweenLogin';
...
function promptToOpenInDesktopApp(initialUrl: string) {
    ...
    if (Str.startsWith(window.location.pathname, Str.normalizeUrl(ROUTES.TRANSITION_BETWEEN_APPS))) {
        ...
        beginMyDeepLinkRedirect(!isMagicLink, getInternalNewExpensifyPath(initialUrl));
    }
}
