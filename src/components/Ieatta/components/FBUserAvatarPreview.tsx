                ...
                <View style={styles.imageModalImageCenterContainer}>
                    ...
                    {!shouldShowNotFoundPage && (
                        <View style={styles.imageModalImageCenterContainer}>
                            <ImagePlaceholder
                                resizeMode="contain"
                                sourceUri={source as string}
                                style={[styles.w50, styles.h40]}
                                imageType="png"
...
FBUserAvatarPreview.displayName = 'FBUserAvatarPreview';

export default memo(FBUserAvatarPreview);
