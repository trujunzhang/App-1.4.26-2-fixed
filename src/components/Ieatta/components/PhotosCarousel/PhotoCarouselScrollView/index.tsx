...
import PhotoCarouselButtons from '@components/Ieatta/components/PhotosCarousel/PhotoCarouselButtons';
...
function PhotoCarouselScrollView({
    ...
    const onViewableItemsChanged = useCallback(
        ({viewableItems, changed}: {viewableItems: ViewToken[]; changed: ViewToken[]}) => {
            ...
            const endIndex = viewableItems.at(viewableItems.length - 1)?.index ?? 0;
