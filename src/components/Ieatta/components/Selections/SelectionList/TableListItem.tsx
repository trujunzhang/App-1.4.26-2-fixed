...
import TextWithTooltip from '@components/Ieatta/components/Selections/TextWithTooltip';
            ...
            {(hovered) => (
                <>
                    {canSelectMultiple && (
                        ...
                        >
                            <View style={[StyleUtils.getCheckboxContainerStyle(20), StyleUtils.getMultiselectListStyles(styles, !!item.isSelected, !!item.isDisabled)]}>
                                {item.isSelected && (
                                    <Icon
