...
type DetailedPageSkeletonViewProps = {
...
function DetailedPageSkeletonView({shouldAnimate = true, possibleVisibleContentItems = 0}: DetailedPageSkeletonViewProps) {
...
DetailedPageSkeletonView.displayName = 'DetailedPageSkeletonView';
export default DetailedPageSkeletonView;
