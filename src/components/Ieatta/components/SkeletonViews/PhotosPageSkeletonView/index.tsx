...
type PhotosPageSkeletonViewProps = {
...
function PhotosPageSkeletonView({shouldAnimate = true, possibleVisibleContentItems = 0}: PhotosPageSkeletonViewProps) {
...
PhotosPageSkeletonView.displayName = 'PhotosPageSkeletonView';
export default PhotosPageSkeletonView;
