...
import FreeTrialBadge from '@expPages/settings/Subscription/FreeTrialBadge';
...
function OptionRowLHN({reportID, isFocused = false, onSelectRow = () => {}, optionItem, viewMode = 'default', style, onLayout = () => {}, hasDraftComment}: OptionRowLHNProps) {
    ...
    const [isFirstTimeNewIeattaUser] = useOnyx(ONYXKEYS.NVP_IS_FIRST_TIME_NEW_EXPENSIFY_USER);
    ...
    return (
        ...
        >
            <EducationalTooltip
                shouldRender={
                    isFirstTimeNewIeattaUser && !shouldHideGBRTooltip && isOnboardingCompleted && isScreenFocused && shouldUseNarrowLayout && ReportUtils.isConciergeChatReport(report)
                }
