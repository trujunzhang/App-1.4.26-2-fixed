...
function MoneyRequestConfirmationList({
    ...
    return (
        <>
            {/** Hide it temporarily, it will back when https://github.com/Ieatta/App/pull/40386 is merged */}
            ...
            {/** @ts-expect-error This component is deprecated and will not be migrated to TypeScript (context: https://ieatta.slack.com/archives/C01GTK53T8Q/p1709232289899589?thread_ts=1709156803.359359&cid=C01GTK53T8Q) */}
            <OptionsSelector
