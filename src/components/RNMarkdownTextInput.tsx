...
type AnimatedMarkdownTextInputRef = typeof TextInput & HTMLInputElement;

// function RNMarkdownTextInputWithRef(props: MarkdownTextInputProps, ref: ForwardedRef<AnimatedMarkdownTextInputRef>) {
function RNMarkdownTextInputWithRef(props: unknown, ref: ForwardedRef<AnimatedMarkdownTextInputRef>) {
