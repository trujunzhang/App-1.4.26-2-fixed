...
function SettlementButton({
    ...
    const shouldShowPaywithIeattaOption = !isPaidGroupPolicy || (!shouldHidePaymentOptions && ReportUtils.isPayer(session, iouReport as OnyxEntry<Report>));
    ...
    const paymentButtonOptions = useMemo(() => {
        ...
        const paymentMethods = {
            [CONST.IOU.PAYMENT_TYPE.EXPENSIFY]: {
                text: translate('iou.settleIeatta', {formattedAmount}),
        ...
        if (isExpenseReport && shouldShowPaywithIeattaOption) {
