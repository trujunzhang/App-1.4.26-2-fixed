            ...
            content: ({styles}: {styles: ThemeStyles}) => (
                <>
                    ...
                    <Text style={styles.textNormal}>
                        Chat is the foundation of New Ieatta. Every expense, expense report, workspace, or member has an associated "chat", which you can use to record additional details, or
                    ...
                    <BulletList
                        ...
                        items={[
                            <Text style={styles.textNormal}>
                                ...
                                and <TextLink href="https://help.expensify.com/articles/new-expensify/chat/Send-and-format-chat-messages">more</TextLink>.
                            </Text>,
                            <Text style={styles.textNormal}>
                            ...
                            <BulletList
                                ...
                                items={[
                                    <Text style={styles.textNormal}>
                                        ...
                                        Concierge and a setup specialist will be added. Feel free to ask any setup questions you have about how to configure the workspace, onboard your team,
                                        connect your accounting, or anything else you might need.
                                    </Text>,
                                    <Text style={styles.textNormal}>
