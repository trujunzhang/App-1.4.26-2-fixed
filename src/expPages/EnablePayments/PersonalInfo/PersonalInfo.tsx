...
// TODO: uncomment after connecting steps https://github.com/Ieatta/App/issues/36648
// import {parsePhoneNumber} from '@libs/PhoneNumber';
import Navigation from '@navigation/Navigation';
import * as Wallet from '@userActions/Wallet';
import CONST from '@src/CONST';
import getInitialSubstepForPersonalInfo from '@src/expPages/EnablePayments/utils/getInitialSubstepForPersonalInfo';
...
function PersonalInfoPage({walletAdditionalDetails, walletAdditionalDetailsDraft}: PersonalInfoPageProps) {
    ...
    const handleBackButtonPress = () => {
        // TODO: connect to the fist step of the wallet setup https://github.com/Ieatta/App/issues/36648
        if (isEditing) {
            goToTheLastStep();
            return;
        }
