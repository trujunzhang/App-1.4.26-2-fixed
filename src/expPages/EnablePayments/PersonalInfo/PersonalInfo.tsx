import IdologyQuestions from '@expPages/EnablePayments/IdologyQuestions';
import getInitialSubstepForPersonalInfo from '@expPages/EnablePayments/utils/getInitialSubstepForPersonalInfo';
