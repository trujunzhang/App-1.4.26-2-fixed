...
function InviteReportParticipantsPage({betas, personalDetails, report, didScreenTransitionEnd}: InviteReportParticipantsPageProps) {
    ...
    // Any existing participants and Ieatta emails should not be eligible for invitation
    ...
    const headerMessage = useMemo(() => {
        ...
        const ieattaEmails = CONST.EXPENSIFY_EMAILS as string[];
        if (!userToInvite && ieattaEmails.includes(searchValue)) {
