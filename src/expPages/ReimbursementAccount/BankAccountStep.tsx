                ...
                <ScrollView style={styles.flex1}>
                    ...
                    <View style={[styles.mv0, styles.mh5, styles.flexRow, styles.justifyContentBetween]}>
                        ...
                        <PressableWithoutFeedback
                            onPress={() => Link.openExternalLink('https://community.ieatta.com/discussion/5677/deep-dive-how-ieatta-protects-your-information/')}
                            style={[styles.flexRow, styles.alignItemsCenter]}
                            accessibilityLabel={translate('bankAccount.yourDataIsSecure')}
                        >
                            <TextLink href="https://community.ieatta.com/discussion/5677/deep-dive-how-ieatta-protects-your-information/">
