...
function EnableBankAccount({reimbursementAccount, user, onBackButtonPress}: EnableBankAccountProps) {
    ...
    const isUsingIeattaCard = user?.isUsingIeattaCard;
    ...
    return (
        ...
        >
            ...
            <ScrollView style={[styles.flex1]}>
                <Section
                    title={!isUsingIeattaCard ? translate('workspace.bankAccount.oneMoreThing') : translate('workspace.bankAccount.allSet')}
                    icon={!isUsingIeattaCard ? Illustrations.ConciergeNew : Illustrations.ThumbsUpStars}
                >
                    <OfflineWithFeedback
                    ...
                    >
                        ...
                        <Text style={[styles.mv3]}>
                            {!isUsingIeattaCard ? translate('workspace.bankAccount.accountDescriptionNoCards') : translate('workspace.bankAccount.accountDescriptionWithCards')}
                        </Text>
                        {!isUsingIeattaCard && (
                            <Button
