...
import WorkspaceCardCreateAWorkspace from '@src/expPages/workspace/card/WorkspaceCardCreateAWorkspace';
                ...
                data: [
                    {
                        ...
                        policyID: '',
                        icons: [{source: Expensicons.IeattaAppIcon, name: CONST.WORKSPACE_SWITCHER.NAME, type: CONST.ICON_TYPE_AVATAR}],
