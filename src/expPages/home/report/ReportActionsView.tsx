...
function ReportActionsView({
    ...
    useEffect(() => {
        // Temporary solution for handling REPORT_PREVIEW. More details: https://ieatta.slack.com/archives/C035J5C9FAP/p1705417778466539?thread_ts=1705035404.136629&cid=C035J5C9FAP
