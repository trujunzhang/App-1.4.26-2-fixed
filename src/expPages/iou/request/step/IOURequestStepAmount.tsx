...
import MoneyRequestAmountForm from '@src/expPages/iou/MoneyRequestAmountForm';
...
function IOURequestStepAmount({
    ...
    useEffect(() => {
        ...
        // It should be removed after this issue https://github.com/Ieatta/App/issues/34607 is fixed
