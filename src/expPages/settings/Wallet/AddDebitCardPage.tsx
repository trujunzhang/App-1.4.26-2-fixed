...
function IAcceptTheLabel() {
    ...
    return (
        <Text>
            ...
            <TextLink href={CONST.TERMS_URL}>{`${translate('common.ieattaTermsOfService')}`}</TextLink>
        </Text>
    );
}
        ...
        >
            ...
            >
                ...
                <InputWrapper
                    ...
                    accessibilityLabel={`${translate('common.iAcceptThe')} ${translate('common.ieattaTermsOfService')}`}
