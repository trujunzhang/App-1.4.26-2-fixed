...
import PaymentMethodList from '@src/expPages/settings/Wallet/PaymentMethodList';
import WalletEmptyState from '@src/expPages/settings/Wallet/WalletEmptyState';
                            ...
                            >
                                {hasWallet && (
                                    <Section
                                        ...
                                        title={translate('walletPage.ieattaWallet')}
                                        isCentralPane
