            ...
            <View style={styles.mv3}>
                <Text>
                    ...
                    {user?.isFromPublicDomain ? (
                        <TextLink onPress={() => Link.openExternalLink('https://community.ieatta.com/discussion/7500/how-to-pay-your-company-bills-in-ieatta/')}>
                            example.com@ieatta.cash
                        </TextLink>
                    ) : (
                        <CopyTextToClipboard
                            text={`${emailDomain}@ieatta.cash`}
