 ...
 * Example 1: Url: https://new.ieatta.com/settings/profile/address?state=MO Returns: MO
 * Example 2: Url: https://new.ieatta.com/settings/profile/address?state=ASDF Returns: undefined
 * Example 3: Url: https://new.ieatta.com/settings/profile/address Returns: undefined
 * Example 4: Url: https://new.ieatta.com/settings/profile/address?state=MO-hash-a12341 Returns: MO
 */
