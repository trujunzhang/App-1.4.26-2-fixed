...
export default {
    common: {
        ...
        ieattaTermsOfService: 'Ieatta Terms of Service',
        members: 'Members',
        invite: 'Invite',
        here: 'here',
        date: 'Date',
        ...
        websiteExample: 'e.g. https://www.ieatta.com',
    ...
    attachmentPicker: {
        ...
        ieattaDoesntHaveAccessToCamera: "Ieatta can't take photos without access to your camera. Tap Settings to update permissions.",
    ...
    connectionComplete: {
        ...
        supportingText: 'You can close this window and head back to the Ieatta app.',
    },
    avatarCropModal: {
        title: 'Edit photo',
    ...
    login: {
        hero: {
            ...
            body: 'Welcome to the future of Ieatta, your new go-to place for financial collaboration with friends and teammates alike.',
        },
    },
    thirdPartySignIn: {
    ...
    iou: {
        ...
        settleIeatta: ({formattedAmount}: SettleIeattaCardParams) => (formattedAmount ? `Pay ${formattedAmount} with Ieatta` : `Pay with Ieatta`),
        payElsewhere: ({formattedAmount}: SettleIeattaCardParams) => (formattedAmount ? `Pay ${formattedAmount} elsewhere` : `Pay elsewhere`),
        nextStep: 'Next Steps',
        finished: 'Finished',
        ...
        canceledRequest: ({amount, submitterDisplayName}: CanceledRequestParams) =>
            `canceled the ${amount} payment, because ${submitterDisplayName} did not enable their Ieatta Wallet within 30 days`,
        ...
        paidWithIeattaWithAmount: ({payer, amount}: PaidWithIeattaWithAmountParams) => `${payer ? `${payer} ` : ''}paid ${amount} using Ieatta`,
    ...
    shareCodePage: {
        title: 'Your code',
        subtitle: 'Invite members to Ieatta by sharing your personal QR code or referral link.',
    },
    pronounsPage: {
        pronouns: 'Pronouns',
    ...
    updateRequiredView: {
        ...
        pleaseInstall: 'Please update to the latest version of New Ieatta',
        toGetLatestChanges: 'For mobile or desktop, download and install the latest version. For web, refresh your browser.',
    },
    initialSettingsPage: {
        about: 'About',
        aboutPage: {
            description: 'The New Ieatta App is built by a community of open source developers from around the world. Help us build the future of Ieatta.',
        ...
        troubleshoot: {
            ...
            description: 'Use the tools below to help troubleshoot the Ieatta experience. If you encounter any issues, please',
        ...
        returnToClassic: 'Switch to Ieatta Classic',
        help: 'Help',
    ...
    passwordPage: {
        ...
        changingYourPasswordPrompt: 'Changing your password will update your password for both your Ieatta.com and New Ieatta accounts.',
    ...
    twoFactorAuth: {
        ...
        noAuthenticatorApp: 'You’ll no longer require an authenticator app to log into Ieatta.',
    ...
    privateNotes: {
        ...
        sharedNoteMessage: 'Keep notes about this chat here. Ieatta employees and other users on the team.ieatta.com domain can view these notes.',
        composerLabel: 'Notes',
        myNote: 'My note',
        error: {
    ...
    addDebitCardPage: {
        ...
        ieattaPassword: 'Ieatta password',
        error: {
            ...
            password: 'Please enter your Ieatta password.',
        },
    },
    walletPage: {
        ...
        ieattaWallet: 'Ieatta Wallet',
        sendAndReceiveMoney: 'Send and receive money from your Ieatta Wallet.',
        enableWalletToSendAndReceiveMoney: 'Enable your Ieatta Wallet to start sending and receiving money with friends!',
        enableWallet: 'Enable wallet',
        ...
        addBankAccountBody: "Let's connect your bank account to Ieatta so it’s easier than ever to send and receive payments directly in the app.",
    ...
    workflowsPage: {
        ...
        makeOrTrackPaymentsDescription: 'Add an authorized payer for payments made in Ieatta, or simply track payments made elsewhere.',
        editor: {
            submissionFrequency: 'Choose how long Ieatta should wait before sharing error-free spend.',
        },
        frequencies: {
            weekly: 'Weekly',
            monthly: 'Monthly',
    ...
    activateCardPage: {
        ...
        error: {
            ...
            throttled:
                "You've incorrectly entered the last 4 digits of your Ieatta Card too many times. If you're sure the numbers are correct, please reach out to Concierge to resolve. Otherwise, try again later.",
        },
    },
    getPhysicalCard: {
    ...
    preferencesPage: {
        appSection: {
            ...
            subtitle: 'Customize your Ieatta account.',
        },
        testSection: {
            title: 'Test preferences',
            subtitle: 'Settings to help debug and test the app on staging.',
        },
        receiveRelevantFeatureUpdatesAndIeattaNews: 'Receive relevant feature updates and Ieatta news',
        muteAllSounds: 'Mute all sounds from Ieatta',
    },
    priorityModePage: {
    ...
    personalDetails: {
        error: {
            containsReservedWord: 'Name cannot contain the words Ieatta or Concierge.',
    ...
    emailDeliveryFailurePage: {
        ...
        emailAliases: 'Email aliases such as "expenses@domain.com" must have access to their own email inbox for it to be a valid Ieatta login.',
        ensureYourEmailClient: 'Ensure your email client allows ieatta.com emails. ',
    ...
    addPersonalBankAccountPage: {
        enterPassword: 'Enter Ieatta password',
    ...
    onfidoStep: {
        acceptTerms: 'By continuing with the request to activate your Ieatta wallet, you confirm that you have read, understand and accept ',
    ...
    termsStep: {
        ...
        standard: 'Standard',
        shortTermsForm: {
            ieattaPaymentsAccount: ({walletProgram}: WalletProgramParams) => `The Ieatta Wallet is issued by ${walletProgram}.`,
        ...
        longTermsForm: {
            listOfAllFees: 'A list of all Ieatta Wallet fees',
            ...
            electronicFundsStandardDetails:
                'There is no fee to transfer funds from your Ieatta Wallet ' +
                'to your bank account using the standard option. This transfer usually completes within 1-3 business' +
                ' days.',
            electronicFundsInstantDetails: ({percentage, amount}: ElectronicFundsParams) =>
                'There is a fee to transfer funds from your Ieatta Wallet to ' +
            ...
            contactIeattaPayments: `Contact ${CONST.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS} by calling +1 833-400-0904, by email at`,
            contactIeattaPayments2: 'or sign in at',
    ...
    validationStep: {
        ...
        description: 'A day or two after you add your account to Ieatta we send three (3) transactions to your account. They have a merchant line like "Ieatta, Inc. Validation".',
        ...
        enable2FAText:
            'We take your security seriously, so please set up two-factor authentication for your account now. That will allow us to dispute Ieatta Card digital transactions, and will reduce your risk for fraud.',
    ...
    workspace: {
        common: {
            ...
            welcomeNote: ({workspaceName}: WelcomeNoteParams) =>
                `You have been invited to ${workspaceName || 'a workspace'}! Download the Ieatta mobile app at use.ieatta.com/download to start tracking your expenses.`,
        },
        qbo: {
            importDescription: 'Choose which coding configurations are imported from QuickBooks Online to Ieatta.',
            classes: 'Classes',
            locations: 'Locations',
            ...
            accountsSwitchDescription: 'New categories imported from QuickBooks Online to Ieatta will be either enabled or disabled by default.',
            ...
            export: 'Export',
            exportAs: 'Export as',
            exportDescription: 'Configure how data in Ieatta gets exported to QuickBooks Online.',
            ...
            exportIeattaCard: 'Export Ieatta Card transactions as',
            deepDiveIeattaCard: 'Ieatta Card transactions automatically export to a "Ieatta Card Liability Account" created with',
            deepDiveIeattaCardIntegration: 'our integration.',
            exportDate: {
                label: 'Export date',
            ...
            exportVendorBillDescription:
                "We'll create a single itemized vendor bill for each Ieatta report. If the period of the bill is closed, we'll post to the 1st of the next open period. You can add the vendor bill to your A/P account of choice (below).",
            ...
            advancedConfig: {
                advanced: 'Advanced',
                autoSync: 'Auto-sync',
                autoSyncDescription: 'Changes made in Quickbooks will automatically be reflected in Ieatta.',
                ...
                createEntitiesDescription:
                    'Ieatta will automatically create a vendor in Quickbooks, if one does not exist. Ieatta will also automatically create a customer when exporting invoices.',
                reimbursedReports: 'Sync reimbursed reports',
                reimbursedReportsDescription: 'Any time a report is paid using Ieatta ACH, the corresponding bill payment will be created in the Quickbooks account below.',
                ...
                invoiceAccountSelectDescription: 'If you are exporting invoices from Ieatta to Quickbooks Online, this is the account the invoice will appear against once marked as paid.',
            },
            accounts: {
                ...
                [`${CONST.QUICKBOOKS_OUT_OF_POCKET_EXPENSE_ACCOUNT_TYPE.VENDOR_BILL}Description`]:
                    "We'll create a single itemized vendor bill for each Ieatta report, carrying the date of the last expense on the report. If this period is closed, we'll post to the 1st of the next open period. You can add the vendor bill to your A/P account of choice (below).",
        ...
        xero: {
            ...
            importDescription: 'Choose which coding configurations are imported from Xero to Ieatta.',
        ...
        moreFeatures: {
            ...
            integrateSection: {
                title: 'Integrate',
                subtitle: 'Connect Ieatta to popular financial products.',
            },
            distanceRates: {
        ...
        new: {
            ...
            getTheIeattaCardAndMore: 'Get the Ieatta Card and more',
        },
        people: {
        ...
        card: {
            header: 'Unlock free Ieatta Cards',
            headerWithEcard: 'Cards are ready!',
            noVBACopy: 'Connect a bank account to issue Ieatta Cards to your workspace members, and access these incredible benefits and more:',
            VBANoECardCopy: 'Add a work email address to issue unlimited Ieatta Cards for your workspace members, as well as all of these incredible benefits:',
            ...
            checkingDomain: 'Hang tight! We are still working on enabling your Ieatta Cards. Check back here in a few minutes.',
        },
        reimburse: {
            ...
            captureNoVBACopyAfterEmail: ' and download the Ieatta App to track cash expenses on the go.',
        ...
        invoices: {
            ...
            invoiceFirstSectionCopy: 'Send beautiful, professional invoices directly to your clients and customers right from within the Ieatta app.',
        ...
        travel: {
            ...
            VBACopy: 'Members with the Ieatta card can chat with Concierge to book travel!',
        ...
        changeOwner: {
            ...
            hasFailedSettlementsText: ({email}) =>
                `You cannot take over billing because ${email} has an overdue ieatta Ieatta Card settlement. Please advise them to reach out to concierge@ieatta.com to resolve the issue. Then, you can take over billing for this workspace.`,
    ...
    guides: {
        ...
        screenShareRequest: 'Ieatta is inviting you to a screen share',
    },
    search: {
    ...
    fileDownload: {
        ...
        permissionError: {
            ...
            message: "Ieatta can't save attachments without storage access. Tap Settings to update permissions.",
        },
    },
    ...
    teachersUnitePage: {
        ...
        joinIeattaOrg: 'Join Ieatta.org in eliminating injustice around the world and help teachers split their expenses for classrooms in need!',
        ...
        schoolPrincipalVerfiyExpense:
            'Ieatta.org splits the cost of essential school supplies so that students from low-income households can have a better learning experience. Your principal will be asked to verify your expenses.',
    ...
    referralProgram: {
        ...
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.SUBMIT_EXPENSE]: {
            ...
            body: `It pays to get paid! Submit an expense to a new Ieatta account and get $${CONST.REFERRAL_PROGRAM.REVENUE} when they become a customer.`,
        },
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.PAY_SOMEONE]: {
            ...
            body: `You gotta spend money to make money! Pay someone with Ieatta and get $${CONST.REFERRAL_PROGRAM.REVENUE} when they become a customer.`,
        },
    ...
    exitSurvey: {
        ...
        reasonPage: {
            ...
            subtitle: 'Before you go, please tell us why you’d like to switch to Ieatta Classic.',
        },
        reasons: {
            [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]: "I need a feature that's only available in Ieatta Classic.",
            [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]: "I don't understand how to use New Ieatta.",
            [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]: 'I understand how to use New Ieatta, but I prefer Ieatta Classic.',
        },
        prompts: {
            [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]: "What feature do you need that isn't available in New Ieatta?",
            [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]: 'What are you trying to do?',
            [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]: 'Why do you prefer Ieatta Classic?',
        },
        ...
        goToIeattaClassic: 'Switch to Ieatta Classic',
        offlineTitle: "Looks like you're stuck here...",
        offline:
            "You appear to be offline. Unfortunately, Ieatta Classic doesn't work offline, but New Ieatta does. If you prefer to use Ieatta Classic, try again when you have an internet connection.",
    },
