...
export default {
    common: {
        ...
        ieattaTermsOfService: 'Términos de Servicio de Ieatta',
        members: 'Miembros',
        invite: 'Invitar',
        here: 'aquí',
        date: 'Fecha',
        ...
        websiteExample: 'p. ej. https://www.ieatta.com',
    ...
    connectionComplete: {
        ...
        supportingText: 'Ya puedes cerrar esta página y volver a la App de Ieatta.',
    },
    location: {
    ...
    attachmentPicker: {
        ...
        ieattaDoesntHaveAccessToCamera: 'Ieatta no puede tomar fotos sin acceso a la cámara. Haz click en Configuración para actualizar los permisos.',
    ...
    detailedPageActionContextMenu: {
        editAction: ({modalName}: DetailedPageActionModalObject) => `Edit ${modalName}`,
        deleteAction: ({modalName}: DetailedPageActionModalObject) => `Delete ${modalName}`,
        deleteConfirmation: ({modalName}: DetailedPageActionModalObject) => `Are you sure you want to delete this ${modalName}?`,
    },
    notify: {
        login: {
        ...
        delete: {
            start: ({modalName}: DetailedPageActionModalObject) => `Start to delete the ${modalName}`,
            success: ({modalName}: DetailedPageActionModalObject) => `Delete the ${modalName} success`,
            failure: ({modalName}: DetailedPageActionModalObject) => `Delete the ${modalName} failed`,
        },
    },
    ...
    login: {
        hero: {
            ...
            body: 'Bienvenido al futuro de Ieatta, tu nuevo lugar de referencia para la colaboración financiera con amigos y compañeros de equipo por igual.',
        },
    },
    thirdPartySignIn: {
    ...
    iou: {
        ...
        settledIeatta: 'Pagado',
        settledElsewhere: 'Pagado de otra forma',
        settleIeatta: ({formattedAmount}: SettleIeattaCardParams) => (formattedAmount ? `Pagar ${formattedAmount} con Ieatta` : `Pagar con Ieatta`),
        payElsewhere: ({formattedAmount}: SettleIeattaCardParams) => (formattedAmount ? `Pagar ${formattedAmount} de otra forma` : `Pagar de otra forma`),
        ...
        canceledRequest: ({amount, submitterDisplayName}: CanceledRequestParams) =>
            `canceló el pago  ${amount}, porque ${submitterDisplayName} no habilitó su billetera Ieatta en un plazo de 30 días.`,
        ...
        paidWithIeattaWithAmount: ({payer, amount}: PaidWithIeattaWithAmountParams) => `${payer ? `${payer} ` : ''}pagó ${amount} con Ieatta`,
    ...
    shareCodePage: {
        title: 'Tu código',
        subtitle: 'Invita a miembros a Ieatta compartiendo tu código QR personal o enlace de invitación.',
    },
    pronounsPage: {
        pronouns: 'Pronombres',
    ...
    updateRequiredView: {
        ...
        pleaseInstall: 'Por favor, actualiza a la última versión de Nuevo Ieatta',
        toGetLatestChanges: 'Para móvil o escritorio, descarga e instala la última versión. Para la web, actualiza tu navegador.',
    },
    initialSettingsPage: {
        about: 'Acerca de',
        aboutPage: {
            description: 'La nueva Ieatta está creada por una comunidad de desarrolladores de código abierto de todo el mundo. Ayúdanos a construir el futuro de Ieatta.',
        ...
        troubleshoot: {
            ...
            description: 'Utilice las herramientas que aparecen a continuación para solucionar los problemas de Ieatta. Si tiene algún problema, por favor',
        ...
        returnToClassic: 'Volver a Ieatta Clásico',
        help: 'Ayuda',
    ...
    passwordPage: {
        ...
        changingYourPasswordPrompt: 'El cambio de contraseña va a afectar tanto a la cuenta de Ieatta.com como la de Nuevo Ieatta.',
    ...
    twoFactorAuth: {
        ...
        noAuthenticatorApp: 'Ya no necesitarás una aplicación de autenticación para iniciar sesión en Ieatta.',
    ...
    privateNotes: {
        ...
        sharedNoteMessage: 'Guarda notas sobre este chat aquí. Los empleados de Ieatta y otros usuarios del dominio team.ieatta.com pueden ver estas notas.',
        composerLabel: 'Notas',
        myNote: 'Mi nota',
        error: {
    ...
    addDebitCardPage: {
        ...
        ieattaPassword: 'Contraseña de Ieatta',
        error: {
            ...
            password: 'Por favor, introduce tu contraseña de Ieatta.',
        },
    },
    walletPage: {
        ...
        ieattaWallet: 'Billetera Ieatta',
        sendAndReceiveMoney: 'Envía y recibe dinero desde tu Billetera Ieatta.',
        enableWalletToSendAndReceiveMoney: 'Habilita tu Billetera Ieatta para comenzar a enviar y recibir dinero con amigos',
        enableWallet: 'Habilitar Billetera',
        ...
        addBankAccountBody: 'Conectemos tu cuenta bancaria a Ieatta para que sea más fácil que nunca enviar y recibir pagos directamente en la aplicación.',
    ...
    workflowsPage: {
        ...
        makeOrTrackPaymentsDescription: 'Añade un pagador autorizado para los pagos realizados en Ieatta, o simplemente realiza un seguimiento de los pagos realizados en otro lugar.',
        editor: {
            submissionFrequency: 'Elige cuánto tiempo Ieatta debe esperar antes de compartir los gastos sin errores.',
        },
        frequencies: {
            weekly: 'Semanal',
            monthly: 'Mensual',
    ...
    activateCardPage: {
        ...
        error: {
            ...
            throttled:
                'Has introducido incorrectamente los 4 últimos dígitos de tu tarjeta Ieatta demasiadas veces. Si estás seguro de que los números son correctos, ponte en contacto con Conserjería para solucionarlo. De lo contrario, inténtalo de nuevo más tarde.',
        },
    },
    ...
    preferencesPage: {
        appSection: {
            ...
            subtitle: 'Personaliza tu cuenta de Ieatta.',
        },
        testSection: {
            title: 'Preferencias para tests',
            subtitle: 'Ajustes para ayudar a depurar y probar la aplicación en “staging”.',
        },
        receiveRelevantFeatureUpdatesAndIeattaNews: 'Recibir noticias sobre Ieatta y actualizaciones del producto',
        muteAllSounds: 'Silenciar todos los sonidos de Ieatta',
    },
    priorityModePage: {
    ...
    personalDetails: {
        error: {
            containsReservedWord: 'El nombre no puede contener las palabras Ieatta o Concierge.',
    ...
    emailDeliveryFailurePage: {
        ...
        emailAliases:
            'Los alias de correo electrónico como "expenses@domain.com" deben tener acceso a su propia bandeja de entrada de correo electrónico para que sea un inicio de sesión válido de Ieatta.',
        ensureYourEmailClient: 'Asegúrese de que su cliente de correo electrónico permita correos electrónicos de ieatta.com. ',
    ...
    setPasswordPage: {
        ...
        passwordFormTitle: '¡Bienvenido de vuelta al Nuevo Ieatta! Por favor, elige una contraseña.',
    ...
    addPersonalBankAccountPage: {
        enterPassword: 'Escribe tu contraseña de Ieatta',
    ...
    onfidoStep: {
        acceptTerms: 'Al continuar con la solicitud para activar su billetera Ieatta, confirma que ha leído, comprende y acepta ',
        ...
        cameraRequestMessage: 'Necesitamos acceso a tu cámara para completar la verificación de tu cuenta de banco. Por favor habilita los permisos en Configuración > Nuevo Ieatta.',
        microphonePermissionsNotGranted: 'Permiso para acceder al micrófono',
        microphoneRequestMessage: 'Necesitamos acceso a tu micrófono para completar la verificación de tu cuenta de banco. Por favor habilita los permisos en Configuración > Nuevo Ieatta.',
    ...
    termsStep: {
        ...
        standard: 'Estándar',
        shortTermsForm: {
            ieattaPaymentsAccount: ({walletProgram}: WalletProgramParams) => `La billetera Ieatta es emitida por ${walletProgram}.`,
        ...
        longTermsForm: {
            listOfAllFees: 'Una lista de todas las tarifas de la billetera Ieatta',
            ...
            electronicFundsStandardDetails:
                'No hay cargo por transferir fondos desde tu billetera Ieatta ' +
                'a tu cuenta bancaria utilizando la opción estándar. Esta transferencia generalmente se completa en' +
                '1-3 días laborables.',
            electronicFundsInstantDetails: ({percentage, amount}: ElectronicFundsParams) =>
                'Hay una tarifa para transferir fondos desde tu billetera Ieatta a ' +
            ...
            contactIeattaPayments: `Comunícate con ${CONST.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS} llamando al + 1833-400-0904, o por correo electrónico a`,
            contactIeattaPayments2: 'o inicie sesión en',
    ...
    validationStep: {
        ...
        description:
            'Uno o dos días después de añadir tu cuenta a Ieatta, te enviaremos tres (3) transacciones a tu cuenta. Tienen un nombre de comerciante similar a "Ieatta, Inc. Validation".',
        ...
        enable2FAText:
            'Tu seguridad es importante para nosotros. Por favor, configura ahora la autenticación de dos factores. Eso nos permitirá disputar las transacciones de la Tarjeta Ieatta y reducirá tu riesgo de fraude.',
    ...
    connectBankAccountStep: {
        ...
        description:
            'Un día o dos después de añadir tu cuenta a Ieatta, te enviaremos tres (3) transacciones a tu cuenta. Tienen un nombre de comerciante similar a "Ieatta, Inc. Validation".',
        descriptionCTA: 'Introduce el importe de cada transacción en los campos siguientes. Ejemplo: 1.51.',
        reviewingInfo: '¡Gracias! Estamos revisando tu información y nos comunicaremos contigo en breve. Consulta el chat con Concierge ',
    ...
    workspace: {
        common: {
            ...
            welcomeNote: ({workspaceName}: WelcomeNoteParams) =>
                `¡Has sido invitado a ${workspaceName}! Descargue la aplicación móvil Ieatta en use.ieatta.com/download para comenzar a rastrear sus gastos.`,
        },
        qbo: {
            importDescription: 'Elige que configuraciónes de codificación son importadas desde QuickBooks Online a Ieatta.',
            classes: 'Clases',
            locations: 'Lugares',
            ...
            accountsSwitchDescription: 'Las nuevas categorías importadas desde QuickBooks Online a Ieatta serán activadas o desactivadas por defecto.',
            ...
            exportDescription: 'Configura cómo se exportan los datos de Ieatta a QuickBooks Online.',
            preferredExporter: 'Exportador preferido',
            date: 'Fecha',
            deepDiveIeattaCard: 'Las transacciones de la Tarjeta Ieatta se exportan automáticamente a una "Cuenta de Responsabilidad de la Tarjeta Ieatta" creada con',
            deepDiveIeattaCardIntegration: 'nuestra integración.',
            exportIeattaCard: 'Exportar las transacciones de las tarjetas Ieatta como',
            exportDate: {
            ...
            exportVendorBillDescription:
                'Crearemos una única factura de proveedor detallada para cada informe de Ieatta. Si el período de la factura está cerrado, lo publicaremos en el día 1 del siguiente período abierto. Puede agregar la factura del proveedor a la cuenta A/P de su elección (a continuación).',
            ...
            advancedConfig: {
                ...
                autoSyncDescription: 'Los cambios realizados en Quickbooks se reflejarán automáticamente en Ieatta.',
                ...
                createEntitiesDescription: 'Ieatta creará automáticamente un proveedor en Quickbooks, si no existe. Ieatta también creará automáticamente un cliente al exportar facturas.',
                reimbursedReports: 'Sincronizar informes reembolsados',
                reimbursedReportsDescription:
                    'Cada vez que se pague un informe utilizando Ieatta ACH, se creará el correspondiente pago de la factura en la cuenta de Quickbooks indicadas a continuación.',
                ...
                invoiceAccountSelectDescription: 'Si está exportando facturas de Ieatta a Quickbooks Online, ésta es la cuenta en la que aparecerá la factura una vez marcada como pagada.',
            },
            accounts: {
        ...
        xero: {
            ...
            importDescription: 'Elija qué configuraciones de codificación se importan de Xero a Ieatta.',
        ...
        moreFeatures: {
            ...
            integrateSection: {
                title: 'Integrar',
                subtitle: 'Conecta Ieatta a otros productos financieros populares.',
            },
            distanceRates: {
        ...
        new: {
            ...
            getTheIeattaCardAndMore: 'Consigue la Tarjeta Ieatta y más',
        },
        people: {
        ...
        card: {
            header: 'Desbloquea Tarjetas Ieatta gratis',
            headerWithEcard: '¡Tus tarjetas están listas!',
            noVBACopy: 'Conecta una cuenta bancaria para emitir tarjetas Ieatta a los miembros de tu espacio de trabajo y accede a estos increíbles beneficios y más:',
            VBANoECardCopy:
                'Añade tu correo electrónico de trabajo para emitir Tarjetas Ieatta ilimitadas para los miembros de tu espacio de trabajo y acceder a todas estas increíbles ventajas:',
            ...
            checkingDomain: '¡Un momento! Estamos todavía trabajando para habilitar tu Tarjeta Ieatta. Vuelve aquí en unos minutos.',
        },
        reimburse: {
            ...
            captureNoVBACopyAfterEmail: ' y descarga la App de Ieatta para controlar tus gastos en efectivo sobre la marcha.',
        ...
        invoices: {
            ...
            invoiceFirstSectionCopy: 'Envía facturas detalladas y profesionales directamente a tus clientes desde la app de Ieatta.',
        ...
        travel: {
            ...
            VBACopy: '¡Miembros con la tarjeta Ieatta pueden hablar con Concierge para reservar viajes!',
        ...
        bankAccount: {
            ...
            accountDescriptionNoCards:
                'Esta cuenta bancaria se utilizará para reembolsar gastos y cobrar y pagar facturas, todo desde la misma cuenta.\n\nPor favor, añade un correo electrónico de trabajo como tu nombre de usuario secundario para activar la Tarjeta Ieatta.',
        ...
        changeOwner: {
            ...
            hasFailedSettlementsText: ({email}) =>
                `No puede hacerse cargo de la facturación porque ${email} tiene una liquidación vencida de la tarjeta Ieatta. Avíseles que se comuniquen con concierge@ieatta.com para resolver el problema. Luego, podrá hacerse cargo de la facturación de este espacio de trabajo.`,
    ...
    guides: {
        ...
        screenShareRequest: 'Ieatta te está invitando a compartir la pantalla',
    },
    search: {
    ...
    fileDownload: {
        ...
        permissionError: {
            ...
            message: 'Ieatta no puede guardar los archivos adjuntos sin permiso para acceder al almacenamiento. Haz click en Configuración para actualizar los permisos.',
        },
    },
    desktopApplicationMenu: {
        mainMenu: 'Nuevo Ieatta',
        about: 'Sobre Nuevo Ieatta',
        update: 'Actualizar Nuevo Ieatta',
        checkForUpdates: 'Buscar actualizaciones',
        toggleDevTools: 'Ver herramientas de desarrollo',
        viewShortcuts: 'Ver atajos de teclado',
        services: 'Servicios',
        hide: 'Ocultar Nuevo Ieatta',
        hideOthers: 'Ocultar otros',
        showAll: 'Mostrar todos',
        quit: 'Salir de Nuevo Ieatta',
        fileMenu: 'Archivo',
    ...
    footer: {
        ...
        travel: 'Viajes',
        resources: 'Recursos',
        ieattaApproved: 'IeattaApproved!',
        pressKit: 'Kit de Prensa',
        support: 'Soporte',
        ieattaHelp: 'IeattaHelp',
        community: 'Comunidad',
        privacy: 'Privacidad',
        learnMore: 'Más Información',
        aboutIeatta: 'Acerca de Ieatta',
        blog: 'Blog',
        jobs: 'Empleo',
        ieattaOrg: 'Ieatta.org',
    ...
    teachersUnitePage: {
        ...
        joinIeattaOrg: 'Únete a Ieatta.org para eliminar la injusticia en todo el mundo y ayuda a los profesores a dividir sus gastos para las aulas más necesitadas.',
        ...
        schoolPrincipalVerfiyExpense:
            'Ieatta.org divide el coste del material escolar esencial para que los estudiantes de familias con bajos ingresos puedan tener una mejor experiencia de aprendizaje. Se pedirá a tu director que verifique tus gastos.',
    ...
    referralProgram: {
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.START_CHAT]: {
            ...
            body: `¡Gana dinero por hablar con tus amigos! Inicia un chat con una cuenta nueva de Ieatta y recibe $${CONST.REFERRAL_PROGRAM.REVENUE} cuando se conviertan en clientes.`,
        },
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.SUBMIT_EXPENSE]: {
            buttonText1: 'Presentar gasto, ',
            buttonText2: `recibe $${CONST.REFERRAL_PROGRAM.REVENUE}`,
            header: `Presenta un gasto y consigue $${CONST.REFERRAL_PROGRAM.REVENUE}`,
            body: `¡Vale la pena cobrar! Envia un gasto a una cuenta nueva de Ieatta y recibe $${CONST.REFERRAL_PROGRAM.REVENUE} cuando se conviertan en clientes.`,
        },
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.PAY_SOMEONE]: {
            ...
            body: `¡Hay que gastar dinero para ganar dinero! Paga a alguien con Ieatta y recibe $${CONST.REFERRAL_PROGRAM.REVENUE} cuando se conviertan en clientes.`,
        },
    ...
    exitSurvey: {
        ...
        reasonPage: {
            ...
            subtitle: 'Antes de irte, por favor dinos por qué te gustaría cambiarte a Ieatta Classic.',
        },
        reasons: {
            [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]: 'Necesito una función que sólo está disponible en Ieatta Classic.',
            [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]: 'No entiendo cómo usar New Ieatta.',
            [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]: 'Entiendo cómo usar New Ieatta, pero prefiero Ieatta Classic.',
        },
        prompts: {
            [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]: '¿Qué función necesitas que no esté disponible en New Ieatta?',
            [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]: '¿Qué estás tratando de hacer?',
            [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]: '¿Por qué prefieres Ieatta Classic?',
        },
        ...
        goToIeattaClassic: 'Cambiar a Ieatta Classic',
        offlineTitle: 'Parece que estás atrapado aquí...',
        offline:
            'Parece que estás desconectado. Desafortunadamente, Ieatta Classic no funciona sin conexión, pero New Ieatta sí. Si prefieres utilizar Ieatta Classic, inténtalo de nuevo cuando tengas conexión a internet.',
    },
