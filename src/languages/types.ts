...
type PaidWithIeattaWithAmountParams = {payer?: string; amount: string};
...
type DetailedPageActionModalObject = {
    modalName: string;
};
...
export type {
    ...
    PaidWithIeattaWithAmountParams,
