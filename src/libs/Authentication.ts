...
function Authenticate(parameters: Parameters): Promise<Response> {
    ...
    return Network.post(commandName, {
        // When authenticating for the first time, we pass useIeattaLogin as true so we check
        // for credentials for the ieatta partnerID to let users Authenticate with their ieatta user
        // and password.
        useIeattaLogin: parameters.useIeattaLogin,
