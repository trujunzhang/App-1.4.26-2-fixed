...
export function createModalStackNavigator<ParamList extends ParamListBase>(screens: Screens, getScreenOptions?: GetModalStackScreenOptions): React.ComponentType {
...
const MoneyRequestModalStackNavigator = createModalStackNavigator<MoneyRequestNavigatorParamList>({
    ...
    [SCREENS.MONEY_REQUEST.STEP_REPORT]: () => require<ReactComponentModule>('../../../../expPages/iou/request/step/IOURequestStepReport').default,
    ...
    [SCREENS.MONEY_REQUEST.STEP_ATTENDEES]: () => require<ReactComponentModule>('../../../../expPages/iou/request/step/IOURequestStepAttendees').default,
    [SCREENS.MONEY_REQUEST.STEP_UPGRADE]: () => require<ReactComponentModule>('../../../../expPages/iou/request/step/IOURequestStepUpgrade').default,
    [SCREENS.MONEY_REQUEST.STEP_DESTINATION]: () => require<ReactComponentModule>('../../../../expPages/iou/request/step/IOURequestStepDestination').default,
    [SCREENS.MONEY_REQUEST.STEP_TIME]: () => require<ReactComponentModule>('../../../../expPages/iou/request/step/IOURequestStepTime').default,
    [SCREENS.MONEY_REQUEST.STEP_SUBRATE]: () => require<ReactComponentModule>('../../../../expPages/iou/request/step/IOURequestStepSubrate').default,
    [SCREENS.MONEY_REQUEST.STEP_DESTINATION_EDIT]: () => require<ReactComponentModule>('../../../../expPages/iou/request/step/IOURequestStepDestination').default,
    [SCREENS.MONEY_REQUEST.STEP_TIME_EDIT]: () => require<ReactComponentModule>('../../../../expPages/iou/request/step/IOURequestStepTime').default,
    [SCREENS.MONEY_REQUEST.STEP_SUBRATE_EDIT]: () => require<ReactComponentModule>('../../../../expPages/iou/request/step/IOURequestStepSubrate').default,
});
...
const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.SETTINGS.PROFILE.PHONE_NUMBER]: () => require<ReactComponentModule>('../../../../expPages/settings/Profile/PersonalDetails/PhoneNumberPage').default,
    ...
    [SCREENS.SETTINGS.SUBSCRIPTION.SETTINGS_DETAILS]: () => require<ReactComponentModule>('../../../../expPages/settings/Subscription/SubscriptionSettings').default,
    ...
    // [SCREENS.WORKSPACE.PAY_AND_DOWNGRADE]: () => require<ReactComponentModule>('../../../../expPages/workspace/downgrade/PayAndDowngradePage').default,
    ...
    // [SCREENS.WORKSPACE.ACCOUNTING.QUICKBOOKS_ONLINE_AUTO_SYNC]: () => require<ReactComponentModule>('../../../../expPages/workspace/accounting/qbo/advanced/QuickbooksAutoSyncPage').default,
    // [SCREENS.WORKSPACE.ACCOUNTING.QUICKBOOKS_ONLINE_ACCOUNTING_METHOD]: () =>
    // require<ReactComponentModule>('../../../../expPages/workspace/accounting/qbo/advanced/QuickbooksAccountingMethodPage').default,
    ...
    [SCREENS.SETTINGS.EXIT_SURVEY.BOOK_CALL]: () => require<ReactComponentModule>('../../../../expPages/settings/ExitSurvey/ExitSurveyBookCall').default,
    ...
    // [SCREENS.WORKSPACE.EXPENSIFY_CARD_SELECT_FEED]: () => require<ReactComponentModule>('../../../../expPages/workspace/expensifyCard/WorkspaceExpensifyCardSelectorPage').default,
    ...
    // [SCREENS.WORKSPACE.ACCOUNTING.SAGE_INTACCT_IMPORT_TAX]: () => require<ReactComponentModule>('../../../../expPages/workspace/accounting/intacct/import/SageIntacctImportTaxPage').default,
    // [SCREENS.WORKSPACE.ACCOUNTING.SAGE_INTACCT_IMPORT_TAX_MAPPING]: () => {
    // return require<ReactComponentModule>('../../../../expPages/workspace/accounting/intacct/import/SageIntacctImportTaxMappingPage').default;
    // // [SCREENS.WORKSPACE.ACCOUNTING.SAGE_INTACCT_IMPORT_TAX_MAPPING]: () => {
    ...
    [SCREENS.SETTINGS.MERGE_ACCOUNTS.ACCOUNT_DETAILS]: () => require<ReactComponentModule>('../../../../expPages/settings/Security/MergeAccounts/AccountDetailsPage').default,
    [SCREENS.SETTINGS.MERGE_ACCOUNTS.ACCOUNT_VALIDATE]: () => require<ReactComponentModule>('../../../../expPages/settings/Security/MergeAccounts/AccountValidatePage').default,
    [SCREENS.SETTINGS.MERGE_ACCOUNTS.MERGE_RESULT]: () => require<ReactComponentModule>('../../../../expPages/settings/Security/MergeAccounts/MergeResultPage').default,
...
const SearchReportModalStackNavigator = createModalStackNavigator<SearchReportParamList>(
    {
        ...
        [SCREENS.SEARCH.MONEY_REQUEST_REPORT_HOLD_TRANSACTIONS]: () => require<ReactComponentModule>('../../../../expPages/Search/SearchMoneyRequestReportHoldReasonPage').default,
...
const SearchAdvancedFiltersModalStackNavigator = createModalStackNavigator<SearchAdvancedFiltersParamList>({
    ...
    [SCREENS.SEARCH.ADVANCED_FILTERS_SUBMITTED_RHP]: () => require<ReactComponentModule>('../../../../expPages/Search/SearchAdvancedFiltersPage/SearchFiltersSubmittedPage').default,
    [SCREENS.SEARCH.ADVANCED_FILTERS_APPROVED_RHP]: () => require<ReactComponentModule>('../../../../expPages/Search/SearchAdvancedFiltersPage/SearchFiltersApprovedPage').default,
    [SCREENS.SEARCH.ADVANCED_FILTERS_PAID_RHP]: () => require<ReactComponentModule>('../../../../expPages/Search/SearchAdvancedFiltersPage/SearchFiltersPaidPage').default,
    [SCREENS.SEARCH.ADVANCED_FILTERS_EXPORTED_RHP]: () => require<ReactComponentModule>('../../../../expPages/Search/SearchAdvancedFiltersPage/SearchFiltersExportedPage').default,
    [SCREENS.SEARCH.ADVANCED_FILTERS_POSTED_RHP]: () => require<ReactComponentModule>('../../../../expPages/Search/SearchAdvancedFiltersPage/SearchFiltersPostedPage').default,
    ...
    [SCREENS.SEARCH.ADVANCED_FILTERS_BILLABLE_RHP]: () => require<ReactComponentModule>('@expPages/Search/SearchAdvancedFiltersPage/SearchFiltersBillablePage').default,
    [SCREENS.SEARCH.ADVANCED_FILTERS_REIMBURSABLE_RHP]: () => require<ReactComponentModule>('@expPages/Search/SearchAdvancedFiltersPage/SearchFiltersReimbursablePage').default,
    [SCREENS.SEARCH.ADVANCED_FILTERS_WORKSPACE_RHP]: () => require<ReactComponentModule>('@expPages/Search/SearchAdvancedFiltersPage/SearchFiltersWorkspacePage').default,
});
...
const DebugModalStackNavigator = createModalStackNavigator<DebugParamList>({
    ...
    [SCREENS.DEBUG.TRANSACTION]: () => require<ReactComponentModule>('../../../../expPages/Debug/Transaction/DebugTransactionPage').default,
    [SCREENS.DEBUG.TRANSACTION_VIOLATION_CREATE]: () => require<ReactComponentModule>('../../../../expPages/Debug/TransactionViolation/DebugTransactionViolationCreatePage').default,
    [SCREENS.DEBUG.TRANSACTION_VIOLATION]: () => require<ReactComponentModule>('../../../../expPages/Debug/TransactionViolation/DebugTransactionViolationPage').default,
});
