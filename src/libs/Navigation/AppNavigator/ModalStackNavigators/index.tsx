...
const RightIeattaStackNavigator = createModalStackNavigator<RightIeattaNavigatorParamList>({
    ...
    [SCREENS.RIGHT_IEATTA.TAKE_PHOTO]: () => require('@pages/photos/takePhoto').default as React.ComponentType,
    [SCREENS.RIGHT_IEATTA.LOCAL_PHOTOS]: () => require('@pages/photos/local').default as React.ComponentType,
});

const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    [SCREENS.SETTINGS.ROOT]: () => require('@src/expPages/settings/InitialSettingsPage').default as React.ComponentType,
