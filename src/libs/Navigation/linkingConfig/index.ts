...
const linkingConfig: LinkingOptions<RootStackParamList> = {
    ...
    prefixes: ['app://-/', 'new-ieatta://', 'https://www.ieatta.cash', 'https://staging.ieatta.cash', 'https://dev.new.ieatta.com', CONST.NEW_EXPENSIFY_URL, CONST.STAGING_NEW_EXPENSIFY_URL],
    config,
};
