...
const loadReportScreen = () => require<ReactComponentModule>('@expPages/home/ReportScreen').default;
const loadSidebarScreen = () => require<ReactComponentModule>('@expPages/home/sidebar/BaseSidebarScreen').default;
