...
const loadSearchPage = () => require<ReactComponentModule>('@expPages/Search/SearchPage').default;
const loadSearchMoneyReportPage = () => require<ReactComponentModule>('@expPages/Search/SearchMoneyRequestReportPage').default;
