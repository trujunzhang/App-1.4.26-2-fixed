...
const getLastAccessedReportID = (
    ...
    const lastReport = ReportUtils.findLastAccessedReport(reports, ignoreDefaultRooms, policies, !!isFirstTimeNewIeattaUser, openOnAdminRoom, reportMetadata);
...
function ReportScreenIDSetter({route, reports, policies, navigation, isFirstTimeNewIeattaUser = false, reportMetadata}: ReportScreenIDSetterProps) {
    ...
    useEffect(() => {
        ...
        const reportID = getLastAccessedReportID(reports, !canUseDefaultRooms, policies, isFirstTimeNewIeattaUser, !!reports?.params?.openOnAdminRoom, reportMetadata);
    ...
    }, [route, navigation, reports, canUseDefaultRooms, policies, isFirstTimeNewIeattaUser, reportMetadata]);
