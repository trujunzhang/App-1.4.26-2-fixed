...
// The policy ID parameter should be included in the URL when any of these expPages is opened in the bottom tab.
...
const customGetPathFromState: typeof getPathFromState = (state, options) => {
    // For the Home and Settings expPages we should remove policyID from the params, because on small screens it's displayed twice in the URL
