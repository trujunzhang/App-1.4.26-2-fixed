...
import type {BottomTabName, CentralPaneName, FullScreenName, NavigationPartialRoute, RootStackParamList} from '@libs/NavigationLast/types';
...
function getAdaptedState(state: PartialState<NavigationState<RootStackParamList>>, policyID?: string): GetAdaptedStateReturnType {
    ...
    if (rhpNavigator) {
        ...
        if (topmostNestedRHPRoute) {
            ...
            const isRHPScreenOpenedFromLHN = false;
