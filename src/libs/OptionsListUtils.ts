...
function getSearchText(
    ...
    for (const personalDetail of personalDetailList) {
        if (personalDetail.login) {
            ...
            // More info https://github.com/Ieatta/App/issues/8007
...
function getOptions(
    ...
    if (sortPersonalDetailsByAlphaAsc) {
        // PersonalDetails should be ordered Alphabetically by default - https://github.com/Ieatta/App/issues/8220#issuecomment-1104009435
