...
import {isCorporateCard, isIeattaCard} from './CardUtils';
...
/**
 * Determine whether a transaction is made with an Ieatta card.
 */
function isIeattaCardTransaction(transaction: OnyxEntry<Transaction>): boolean {
    if (!transaction?.cardID) {
        return false;
    }
    return isIeattaCard(transaction.cardID);
}

/**
 * Determine whether a transaction is made with a card (Ieatta or Company Card).
 */
...
function getAllReportTransactions(reportID?: string): Transaction[] {
    ...
    // For reference, https://github.com/Ieatta/App/pull/26536#issuecomment-1703573277.
    // We will update this in a follow-up Issue. According to this comment: https://github.com/Ieatta/App/pull/26536#issuecomment-1703591019.
