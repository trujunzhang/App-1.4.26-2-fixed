...
function getMoneyRequestInformation(
    ...
    // data. This is a big can of worms to change it to `Onyx.merge()` as explored in https://ieatta.slack.com/archives/C05DWUDHVK7/p1692139468252109.
    // I want to clean this up at some point, but it's possible this will live in the code for a while so I've created https://github.com/Ieatta/App/issues/25417
 ...
 *               This setting is necessary while the UpdateDistanceRequest API is refactored to be fully 1:1:1 in https://github.com/Ieatta/App/issues/28358
 */
...
function getPayMoneyRequestParams(
    ...
    const optimisticNextStep = NextStepUtils.buildNextStep(iouReport, CONST.REPORT.STATUS_NUM.REIMBURSED, {isPaidWithIeatta: paymentMethodType === CONST.IOU.PAYMENT_TYPE.VBBA});
