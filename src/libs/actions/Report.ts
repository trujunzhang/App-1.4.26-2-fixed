 ...
 * 1. The "new" way from New Ieatta is passed as {[login]: Boolean} (e.g. {yuwen@ieatta.com: true}), where the value
 * is whether the user with that login is typing/leaving on the report or not.
 * 2. The "old" way from e.com which is passed as {userLogin: login} (e.g. {userLogin: bstites@ieatta.com})
 *
...
function editReportComment(reportID: string, originalReportAction: OnyxEntry<ReportAction>, textForNewComment: string) {
    ...
    // https://github.com/Ieatta/App/issues/9090
    // https://github.com/Ieatta/App/issues/13221
...
function addEmojiReaction(reportID: string, reportActionID: string, emoji: Emoji, skinTone: string | number = preferredSkinTone) {
    ...
    const parameters: AddEmojiReactionParams = {
        ...
        reportActionID,
        createdAt,
        // This will be removed as part of https://github.com/Ieatta/App/issues/19535
...
function toggleEmojiReaction(
    ...
    // This will get cleaned up as part of https://github.com/Ieatta/App/issues/16506 once the old emoji
 ...
 *  Please see https://github.com/Ieatta/App/blob/main/README.md#Security for more details
 */
