...
type TakePhotoScreenDragAndDropWrapperProps = {
...
function TakePhotoScreenDragAndDropWrapper({
    testID,
    headerTitle,
    onBackButtonPress,
    ...
    children,
    shouldShowWrapper,
}: PropsWithChildren<TakePhotoScreenDragAndDropWrapperProps>) {
...
TakePhotoScreenDragAndDropWrapper.displayName = 'TakePhotoScreenDragAndDropWrapper';

export default TakePhotoScreenDragAndDropWrapper;
