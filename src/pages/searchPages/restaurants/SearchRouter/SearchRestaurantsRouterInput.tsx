...
type SearchRestaurantsRouterInputProps = {
    /** Value of TextInput */
    value: string;
    ...
    /** Callback to update search in SearchRestaurantsRouter */
    updateSearch: (searchTerm: string) => void;

    /** Callback invoked when the user submits the input */
    onSubmit?: () => void;

    /** SearchRestaurantsRouterList ref for managing TextInput and SearchRestaurantsRouterList focus */
...
function SearchRestaurantsRouterInput({
    value,
    setValue,
    updateSearch,
    onSubmit = () => {},
...
}: SearchRestaurantsRouterInputProps) {
...
SearchRestaurantsRouterInput.displayName = 'SearchRestaurantsRouterInput';

export default SearchRestaurantsRouterInput;
