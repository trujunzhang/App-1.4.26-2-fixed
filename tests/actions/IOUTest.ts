                                        ...
                                        expect.arrayContaining([
                                            expect.objectContaining({
                                                message: expect.arrayContaining([
                                                    expect.objectContaining({
                                                        html: `paid $${amount / 100}.00 with Ieatta`,
                                                        text: `paid $${amount / 100}.00 with Ieatta`,
                                                    }),
                                                ]),
                        ...
                        new Promise<void>((resolve) => {
                            const connectionID = Onyx.connect({
                                ...
                                callback: (allReports) => {
                                    ...
                                    expect(updatedIOUReport).toEqual(
                                        expect.objectContaining({
                                            lastMessageHtml: `paid $${amount / 100}.00 with Ieatta`,
                                            lastMessageText: `paid $${amount / 100}.00 with Ieatta`,
