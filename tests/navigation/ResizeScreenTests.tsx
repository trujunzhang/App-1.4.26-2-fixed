...
import ProfilePage from '@expPages/settings/Profile/ProfilePage';
...
jest.mock('@expPages/settings/InitialSettingsPage');
jest.mock('@expPages/settings/Profile/ProfilePage');
