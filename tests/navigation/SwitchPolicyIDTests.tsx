import switchPolicyAfterInteractions from '@expPages/WorkspaceSwitcherPage/switchPolicyAfterInteractions';
...
jest.mock('@expPages/home/sidebar/NavigationTabBarAvatar');
