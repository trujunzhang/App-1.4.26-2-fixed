...
const data: ExampleDataType[] = [
    ...
    },
    {
        input: [
            ...
            {commit: '3', subject: 'Merge pull request #337 from Ieatta/francoisUpdateQbdSyncManager', authorName: 'test@gmail.com'},
            {commit: '4', subject: 'Merge pull request #336 from Ieatta/andrew-pr-cla', authorName: 'test@gmail.com'},
            ...
            {commit: '7', subject: 'Merge pull request #331 from Ieatta/marcaaron-killMoment', authorName: 'test@gmail.com'},
            {commit: '8', subject: 'Merge pull request #330 from Ieatta/andrew-cla-update', authorName: 'test@gmail.com'},
            {commit: '9', subject: 'Merge pull request #333 from Ieatta/Rory-AddOnOffSwitchTooltip', authorName: 'test@gmail.com'},
            {commit: '10', subject: 'Setup OnOffSwitch component with tooltips', authorName: 'test@gmail.com'},
            {commit: '11', subject: 'Merge pull request #332 from Ieatta/alex-mechler-patch-1', authorName: 'test@gmail.com'},
