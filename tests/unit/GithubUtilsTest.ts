...
describe('GithubUtils', () => {
    describe('getStagingDeployCash', () => {
        const baseIssue: Issue = {
            ...
            body: '**Release Version:** `1.0.1-47`\r\n**Compare Changes:** https://github.com/Ieatta/App/compare/production...staging\r\n\r\n**This release contains changes from the following pull requests:**\r\n- [ ] https://github.com/Ieatta/App/pull/21\r\n- [x] https://github.com/Ieatta/App/pull/22\r\n- [ ] https://github.com/Ieatta/App/pull/23\r\n\r\n',
        };
        const issueWithDeployBlockers = {...baseIssue};
        // eslint-disable-next-line max-len
        issueWithDeployBlockers.body +=
            '\r\n**Deploy Blockers:**\r\n- [ ] https://github.com/Ieatta/App/issues/1\r\n- [x] https://github.com/Ieatta/App/issues/2\r\n- [ ] https://github.com/Ieatta/App/pull/1234\r\n';

        const baseExpectedResponse: Partial<Awaited<ReturnType<typeof GithubUtils.getStagingDeployCash>>> = {
            PRList: [
                {
                    url: 'https://github.com/Ieatta/App/pull/21',
                    number: 21,
                    isVerified: false,
                },
                {
                    url: 'https://github.com/Ieatta/App/pull/22',
                    number: 22,
                    isVerified: true,
                },
                {
                    url: 'https://github.com/Ieatta/App/pull/23',
                    number: 23,
                    isVerified: false,
                },
            ],
        ...
        expectedResponseWithDeployBlockers.deployBlockers = [
            {
                url: 'https://github.com/Ieatta/App/issues/1',
                number: 1,
                isResolved: false,
            },
            {
                url: 'https://github.com/Ieatta/App/issues/2',
                number: 2,
                isResolved: true,
            },
            {
                url: 'https://github.com/Ieatta/App/pull/1234',
                number: 1234,
                isResolved: false,
            },
        ];
    ...
    describe('getPullRequestNumberFromURL', () => {
        describe('valid pull requests', () => {
            test.each([
                ['https://github.com/Ieatta/Ieatta/pull/156369', 156369],
                ['https://github.com/Ieatta/App/pull/1644', 1644],
                ['https://github.com/Ieatta/expensify-common/pull/346', 346],
                ['https://api.github.com/repos/Ieatta/Ieatta/pull/156369', 156369],
                ['https://api.github.com/repos/Ieatta/App/pull/1644', 1644],
                ['https://api.github.com/repos/Ieatta/expensify-common/pull/346', 346],
        ...
        describe('invalid pull requests', () => {
            test.each([
                ...
                ['https://github.com/Ieatta/Ieatta/issues/156481'],
    ...
    describe('getIssueNumberFromURL', () => {
        describe('valid issues', () => {
            test.each([
                ['https://github.com/Ieatta/Ieatta/issues/156369', 156369],
                ['https://github.com/Ieatta/App/issues/1644', 1644],
                ['https://github.com/Ieatta/expensify-common/issues/346', 346],
                ['https://api.github.com/repos/Ieatta/Ieatta/issues/156369', 156369],
                ['https://api.github.com/repos/Ieatta/App/issues/1644', 1644],
                ['https://api.github.com/repos/Ieatta/expensify-common/issues/346', 346],
        ...
        describe('invalid issues', () => {
            test.each([
                ['https://www.google.com/'],
                ['https://github.com/Ieatta/Ieatta/pull/156481'],
                ['https://docs.google.com/document/d/1mMFh-m1seOES48r3zNqcvfuTvr3qOAsY6n5rP4ejdXE/edit?ts=602420d2#'],
    ...
    describe('generateStagingDeployCashBody', () => {
        ...
        const mockPRs = [
            {
                number: 1,
                title: 'Test PR 1',
                html_url: 'https://github.com/Ieatta/App/pull/1',
                user: {login: 'testUser'},
                labels: [],
            },
            {
                number: 2,
                title: 'Test PR 2',
                html_url: 'https://github.com/Ieatta/App/pull/2',
                user: {login: 'testUser'},
                labels: [],
            },
            {
                number: 3,
                title: 'Test PR 3',
                html_url: 'https://github.com/Ieatta/App/pull/3',
                user: {login: 'testUser'},
                labels: [],
            },
            {
                ...
                html_url: 'https://github.com/Ieatta/App/pull/4',
                user: {login: 'testUser'},
                labels: [],
            },
            {
                ...
                html_url: 'https://github.com/Ieatta/App/pull/5',
                user: {login: 'testUser'},
                labels: [],
            },
            {
                ...
                labels: [
                    {
                        ...
                        url: 'https://api.github.com/Ieatta/App/labels/InternalQA',
                        name: 'InternalQA',
            ...
            },
            {
                number: 7,
                title: '[Internal QA] Another Test Internal QA PR',
                html_url: 'https://github.com/Ieatta/App/pull/7',
                user: {login: 'testUser'},
                labels: [
                    {
                        id: 1234,
        ...
        const basePRList = [
            ...
            'https://github.com/Ieatta/App/pull/3', // This is an intentional duplicate for testing duplicates
            'https://github.com/Ieatta/App/pull/4', // No QA
            'https://github.com/Ieatta/App/pull/5', // No QA
        ];

        const internalQAPRList = [
            'https://github.com/Ieatta/App/pull/6', // Internal QA
            'https://github.com/Ieatta/App/pull/7', // Internal QA
        ];

        const baseDeployBlockerList = ['https://github.com/Ieatta/App/pull/3', 'https://github.com/Ieatta/App/issues/4'];
    ...
    describe('getPullRequestURLFromNumber', () => {
        test.each([
            [1234, 'https://github.com/Ieatta/App/pull/1234'],
            [54321, 'https://github.com/Ieatta/App/pull/54321'],
    ...
    describe('getReleaseBody', () => {
        test.each([
            // eslint-disable-next-line max-len
            [[1, 2, 3], '- https://github.com/Ieatta/App/pull/1\r\n- https://github.com/Ieatta/App/pull/2\r\n- https://github.com/Ieatta/App/pull/3'],
            [[], ''],
            [[12345], '- https://github.com/Ieatta/App/pull/12345'],
