...
describe('OptionsListUtils', () => {
    ...
    const PERSONAL_DETAILS: PersonalDetailsList = {
        ...
        '2': {
            ...
            login: 'tonystark@ieatta.com',
            reportID: '1',
        },
        '3': {
            accountID: 3,
            displayName: 'Spider-Man',
            login: 'peterparker@ieatta.com',
            reportID: '1',
        },
        '4': {
            accountID: 4,
            displayName: 'Black Panther',
            login: 'tchalla@ieatta.com',
            reportID: '1',
        },
        '5': {
            accountID: 5,
            displayName: 'Invisible Woman',
            login: 'suestorm@ieatta.com',
            reportID: '1',
        },
        '6': {
            accountID: 6,
            displayName: 'Thor',
            login: 'thor@ieatta.com',
            reportID: '1',
        },
        '7': {
            accountID: 7,
            displayName: 'Captain America',
            login: 'steverogers@ieatta.com',
            reportID: '1',
        },
        '8': {
            accountID: 8,
        ...
        '9': {
            ...
            login: 'natasharomanoff@ieatta.com',
            reportID: '',
        },
        '10': {
            accountID: 10,
            displayName: 'The Incredible Hulk',
            login: 'brucebanner@ieatta.com',
            reportID: '',
        },
    };
    ...
    beforeAll(() => {
        Onyx.init({
            keys: ONYXKEYS,
            initialKeyStates: {
                [ONYXKEYS.SESSION]: {accountID: 2, email: 'tonystark@ieatta.com'},
    ...
    it('getSearchOptions()', () => {
        ...
        expect(results.recentReports[0].login).toBe('peterparker@ieatta.com');
        ...
        return waitForBatchedUpdates()
            ...
            .then(() => {
                ...
                results = OptionsListUtils.getSearchOptions(OPTIONS_WITH_PERIODS, 'barry.allen@ieatta.com');
    ...
    it('getFilteredOptions()', () => {
        ...
        const personalDetailWithExistingReport = results.personalDetails.find((personalDetail) => personalDetail.login === 'peterparker@ieatta.com');
        ...
        results = OptionsListUtils.getFilteredOptions(OPTIONS.reports, OPTIONS.personalDetails, [], 'peterparker@ieatta.com');
        ...
        expect(results.personalDetails[0].login).toBe('natasharomanoff@ieatta.com');
        ...
        expect(results.recentReports).toEqual(expect.arrayContaining([expect.objectContaining({login: 'concierge@ieatta.com'})]));
        ...
        expect(results.personalDetails).not.toEqual(expect.arrayContaining([expect.objectContaining({login: 'concierge@ieatta.com'})]));
        ...
        expect(results.personalDetails).not.toEqual(expect.arrayContaining([expect.objectContaining({login: 'chronos@ieatta.com'})]));
        ...
        expect(results.personalDetails).not.toEqual(expect.arrayContaining([expect.objectContaining({login: 'receipts@ieatta.com'})]));
    });
    ...
    it('getFilteredOptions() for group Chat', () => {
        ...
        expect(results.personalDetails[0].login).toBe('brucebanner@ieatta.com');
        ...
        expect(results.recentReports.every((option) => option.login !== 'peterparker@ieatta.com')).toBe(true);
        expect(results.personalDetails.every((option) => option.login !== 'peterparker@ieatta.com')).toBe(false);

        // When we provide a "selected" option to getFilteredOptions()
        results = OptionsListUtils.getFilteredOptions(OPTIONS.reports, OPTIONS.personalDetails, [], '', [{login: 'peterparker@ieatta.com'}]);

        // Then the option should not appear anywhere in either list
        expect(results.recentReports.every((option) => option.login !== 'peterparker@ieatta.com')).toBe(true);
        expect(results.personalDetails.every((option) => option.login !== 'peterparker@ieatta.com')).toBe(true);

        // When we add a search term for which no options exist and the searchValue itself
        // is not a potential email or phone
        results = OptionsListUtils.getFilteredOptions(OPTIONS.reports, OPTIONS.personalDetails, [], 'marc@ieatta');
        ...
        results = OptionsListUtils.getFilteredOptions(OPTIONS.reports, OPTIONS.personalDetails, [], 'marc@ieatta.com');
        ...
        results = OptionsListUtils.getFilteredOptions(OPTIONS.reports, OPTIONS.personalDetails, [], 'peter.parker@ieatta.com');
        ...
        expect(results.personalDetails).not.toEqual(expect.arrayContaining([expect.objectContaining({login: 'concierge@ieatta.com'})]));
        expect(results.recentReports).not.toEqual(expect.arrayContaining([expect.objectContaining({login: 'concierge@ieatta.com'})]));
        ...
        expect(results.personalDetails).not.toEqual(expect.arrayContaining([expect.objectContaining({login: 'chronos@ieatta.com'})]));
        expect(results.recentReports).not.toEqual(expect.arrayContaining([expect.objectContaining({login: 'chronos@ieatta.com'})]));
        ...
        expect(results.personalDetails).not.toEqual(expect.arrayContaining([expect.objectContaining({login: 'receipts@ieatta.com'})]));
        expect(results.recentReports).not.toEqual(expect.arrayContaining([expect.objectContaining({login: 'receipts@ieatta.com'})]));
    });
    ...
    it('getShareDestinationsOptions()', () => {
        ...
        const filteredReportsWithWorkspaceRooms = Object.values(OPTIONS_WITH_WORKSPACES.reports).reduce<OptionsListUtils.OptionList['reports']>((filtered, option) => {
            ...
            if (ReportUtils.canUserPerformWriteAction(report) || ReportUtils.isIeattaOnlyParticipantInReport(report)) {
                filtered.push(option);
            }
            return filtered;
        }, []);
    ...
    it('getMemberInviteOptions()', () => {
        ...
        // When we provide a search value that matches an email
        results = OptionsListUtils.getMemberInviteOptions(OPTIONS.personalDetails, [], 'peterparker@ieatta.com');
    ...
    describe('filterOptions', () => {
        ...
        it('should filter options by email if dot is skipped in the email', () => {
            ...
            expect(filteredOptions.recentReports.length).toBe(1);
            expect(filteredOptions.recentReports[0].login).toBe('barry.allen@ieatta.com');
        });
        ...
        it('should put exact match by login on the top of the list', () => {
            const searchText = 'reedrichards@ieatta.com';
            const options = OptionsListUtils.getSearchOptions(OPTIONS, '', [CONST.BETAS.ALL]);
