...
const keywordTests = [
    ...
    {
        query: '"https://expensify.com" "https://new.ieatta.com"',
        expected: {
            type: 'expense',
            status: 'all',
            sortBy: 'date',
            ...
            filters: {
                operator: 'eq',
                left: 'keyword',
                right: ['https://expensify.com', 'https://new.ieatta.com'],
            },
        },
    },
    {
        query: '""https://expensify.com"" to ""https://new.ieatta.com""', // Nested quotes with a colon
        expected: {
            type: 'expense',
            status: 'all',
            sortBy: 'date',
            ...
            filters: {
                operator: 'eq',
                left: 'keyword',
                right: ['"https://expensify.com"', 'to', '"https://new.ieatta.com"'],
            },
        },
    },
    {
        query: '"""https://expensify.com" to "https://new.ieatta.com"""', // Mismatched quotes
        expected: {
            type: 'expense',
            status: 'all',
            sortBy: 'date',
    ...
    {
        query: 'date>2024-01-01 from:usera@user.com "https://expensify.com" "https://new.ieatta.com"',
        expected: {
            type: 'expense',
            status: 'all',
            sortBy: 'date',
