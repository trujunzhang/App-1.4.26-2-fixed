        ...
        it('returns the last action message as an alternate text if the action is POLICYCHANGELOG_LEAVEROOM type', async () => {
            ...
            const lastAction: ReportAction = {
                ...
                message: [
                    {
                        type: 'COMMENT',
                        html: '<muted-text>removed <mention-user accountID=19010378></mention-user> from <a href="https://dev.new.ieatta.com:8082/r/5345362886584843" target="_blank">#r1</a></muted-text>',
