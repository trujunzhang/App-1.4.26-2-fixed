...
describe('Url', () => {
    describe('getPathFromURL()', () => {
        it('It should work correctly', () => {
            ...
            expect(
                Url.getPathFromURL(
                    'https://new.ieatta.com/r/443044983936732/attachment?source=https://www.expensify.com/chat-attachments/3915228701265930556/w_a758d3c8444a64f98d37205b17141388064d458e.jpg',
                ),
    ...
    describe('hasSameExpensifyOrigin()', () => {
        describe('happy path', () => {
            it('It should work correctly', () => {
                expect(Url.hasSameExpensifyOrigin('https://new.ieatta.com/inbox/124', 'https://new.ieatta.com/inbox/123')).toBe(true);
            });
            it('It should work correctly with www in both urls', () => {
                expect(Url.hasSameExpensifyOrigin('https://www.new.ieatta.com/inbox/124', 'https://www.new.ieatta.com/action/123')).toBe(true);
            });
            it('It should work correctly with www in one of two urls', () => {
                expect(Url.hasSameExpensifyOrigin('https://new.ieatta.com/action/1234', 'https://www.new.ieatta.com/action/123')).toBe(true);
            });
        ...
        describe('failure path', () => {
            it('It should work correctly with two origin urls', () => {
                expect(Url.hasSameExpensifyOrigin('https://new.ieatta.com/inbox/124', 'https://expensify.com/inbox/123')).toBe(false);
            });
            it('It should work correctly with www', () => {
                expect(Url.hasSameExpensifyOrigin('https://www.expensify.com/inbox/124', 'https://www.new.ieatta.com/action/123')).toBe(false);
            });
            it('It should work correctly with  www', () => {
                expect(Url.hasSameExpensifyOrigin('https://expensify.com/action/1234', 'https://www.new.ieatta.com/action/123')).toBe(false);
            });
        });
    });
});
