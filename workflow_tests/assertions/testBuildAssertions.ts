...
function assertValidateActorJobExecuted(workflowResult: Step[], pullRequestNumber = '1234', didExecute = true) {
    const steps = [
        createStepAssertion('Is Ieatta employee', true, null, 'VALIDATEACTOR', 'Is Ieatta employee', [], [{key: 'GITHUB_TOKEN', value: '***'}]),
        createStepAssertion(
    ...
    const steps = [
        ...
        createStepAssertion(
            ...
            [
                ...
                {key: 'S3_BUCKET', value: 'ad-hoc-ieatta-cash'},
    ...
    steps.push(
        createStepAssertion(
            ...
            [
                ...
                {key: 'DESKTOP_LINK', value: `https://ad-hoc-ieatta-cash.s3.amazonaws.com/desktop/${pullRequestNumber}/NewIeatta.dmg`},
                {key: 'IOS_LINK', value: iOSStatus === 'success' ? 'http://dummy.ios.link' : ''},
                {key: 'WEB_LINK', value: `https://${pullRequestNumber}.pr-testing.ieatta.com`},
            ],
            [],
        ),
    );
